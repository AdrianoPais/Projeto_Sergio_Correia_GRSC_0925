...
# 0 - Definir permissões do script
...
# ----------------------------------------------------
# 1 - Recolha de informações do utilizador
...
echo "A configurar named.conf com Forwarder 8.8.8.8..."
...
# ----------------------------------------------------
# 20 - Menu de verificações opcionais
...
echo ""
echo "Deseja executar verificações finais? (s/n): "
read -p "Resposta: " FAZER_VERIFICACOES

if [[ "$FAZER_VERIFICACOES" == "s" || "$FAZER_VERIFICACOES" == "S" ]]; then
    echo ""
